// pages/feature6/monitor3/monitor3.js
...
Page({
  data: {
    ...
    sheepInfo: {
      total: 120,
      ageDistribution: {
        newborn: { label: '新生羔羊（0 - 3 个月）', percentage: 15 },
        young: { label: '年轻成年羊（3 - 12 个月）', percentage: 35 },
        adult: { label: '成年羊（1 - 5 岁）', percentage: 35 },
        old: { label: '老年羊（5 岁以上）', percentage: 15 }
      },
      health: '羊只健康状况良好',
      activity: '羊群在羊圈内正常活动',
  ...
  onLoad(options) {
    ...
    const monitorId = options.monitorId || 'monitor3';
    this.setData({
      monitorId: monitorId
    });
